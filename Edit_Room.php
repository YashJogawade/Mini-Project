<?php 
  ...
  {   if(!empty($_POST['title']) && !empty($_POST['location']) && !empty($_POST['category']) &&  !empty($_POST['description']) && !empty($_POST['price']) && !empty($_FILES["image1"]["tmp_name"]) && !empty($_FILES["image2"]["tmp_name"]) &&  !empty($_FILES["image3"]["tmp_name"]) )
     { $dbhost='localhost';
	   ...
	   $sql="UPDATE room SET title='$title',category='$category',location='$location',description='$description',price='$price',image1='$image1',image2='$image2',image3='$image3' WHERE room_id='$room_id'" ;
...
<section class="ad-post bg-gray py-5">
    <div class="container">
        <form action="Edit_Room.php" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="border border-gary p-4 mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="price">
                                <h6 class="font-weight-bold pt-4 pb-1">Price/Rent(Rs):</h6>
                                <div class="row px-3">
            ...
            <button type="submit" name="postad" class="btn btn-primary d-block mt-2" href="Edit_Room.php">Post Your Ad</button>
        </form>
    </div>
</section>
<!--============================
