<?php session_start();
  ...
  {  if(!empty($_POST['title']) && !empty($_POST['location']) && !empty($_POST['category']) &&  !empty($_POST['description']) && !empty($_POST['price']) && !empty($_FILES["image1"]["tmp_name"]) && !empty($_FILES["image2"]["tmp_name"]) &&  !empty($_FILES["image3"]["tmp_name"]) )
     { $dbhost='localhost';
	   ...
	   $sql="Insert into room values('','$title','$category','$location','$description','$price','$image1','$image2','$image3','$User_id',0)" ;
	   $a=mysqli_query($con,$sql) ;
	   if($a)
	    {   echo '<script> alert("Ad posted successfully..!"); window.location.href="Add room.php"; </script>' ;
	    }
		else
		{  echo '<script> alert("Failed to post ad..!"); window.location.href="Add room.php"; </script>' ; }
     }
	 else 
     { echo '<script> alert("Fill all the details."); window.location.href="Add room.php"; </script>' ;}
  }
?>
            ...
            <fieldset class="border border-gary p-4 mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="price">
                                <h6 class="font-weight-bold pt-4 pb-1">Rent ( Monthly in Rs ):</h6>
                                <div class="row px-3">
