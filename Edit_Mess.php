<?php 
  ...
  {   if(!empty($_POST['title']) && !empty($_POST['location']) && !empty($_POST['category']) &&  !empty($_POST['description']) && !empty($_FILES["image1"]["tmp_name"]) && !empty($_FILES["image2"]["tmp_name"]) &&  !empty($_FILES["image3"]["tmp_name"]) )
     { $dbhost='localhost';
	   ...
	   $sql="UPDATE mess SET title='$title',category='$category',location='$location',description='$description',image1='$image1',image2='$image2',image3='$image3' WHERE mess_id='$mess_id'" ;
...
<section class="ad-post bg-gray py-5">
    <div class="container">
        <form action="Edit_Room.php" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" name="postad" class="btn btn-primary d-block mt-2" href="Edit_Mess.php">Post Your Ad</button>
        </form>
    </div>
</section>
<!--============================
