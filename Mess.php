...
<section class="hero-area bg-1_1 text-center overly">
	<!-- Container Start -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="short-popular-category-list text-center">
						...
						<ul class="list-inline">
							<li class="list-inline-item">
								<a href="Room.php"><i class="fa fa-bed"></i>Rooms</a></li>
							<li class="list-inline-item">
								<a href="#" class="select"><i class="fa fa-cutlery"></i> Mess</a>
							</li>
							<li class="list-inline-item">
...
<div class="widget category-list">
	...
	<ul class="category-list">
		<li><a href="">Mess<span></span></a></li>
		<li><a href="">Cafes<span></span></a></li>
		<li><a href="">Restaurants <span></span></a></li>
...
<div class="widget category-list">
	<h4 class="widget-header">Sort by Category</h4>
	<ul class="category-list">
	    <form method="POST">
		<li>Mess <input type="radio" style="margin-left:130px;" name="filter" value="1"></li><br>
		<li>Cafe <input type="radio" style="margin-left:133px;" name="filter" value="2"></li><br>
		<li>Restaurant <input type="radio" style="margin-left:92px;"  name="filter"  value="3"></li><br>
		<li>Others <input type="radio" style="margin-left:119px;"  name="filter"  value="4"></li><br>
		</form>
	</ul>
...
<section class="call-to-action overly bg-3_1 section-sm">
	<!-- Container Start -->
	<div class="container">
			...
			<div class="col-md-8">
				<div class="content-holder">
					...
					<ul class="list-inline mt-30">
						<li class="list-inline-item"><a class="btn btn-main" href="ad-listing.html"  data-toggle="modal" data-target="#PostAd" style="color:white">Post Ads</a></li>
						<li class="list-inline-item"><a class="btn btn-main" href="Sign-In.html"  data-toggle="modal" data-target="#Logout" style="color:white">Log Out</a></li>
					</ul>
				</div>
			</div>
		</div>
