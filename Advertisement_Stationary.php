<?php session_start();
  ...
  {  
     $_SESSION['stationery_id']=$_POST['stationery_id'];
     $stationery_id=$_SESSION['stationery_id'];
  }
  ...
  {    $dbhost='localhost';
	   ...
	   $q="select * from favourite_stationery where User_id='$User_id' AND stationery_id='$stationery_id'";
	   $res=mysqli_query($con,$q);
	   $n=mysqli_num_rows($res);
	   
	   if($n==0){
	   $sql="INSERT INTO favourite_stationery values('$User_id','$stationery_id')";
       $a=mysqli_query($con,$sql);
       if($a)
	   {  setcookie($stationery_id,'1');
	      echo '<script> alert("Added to your favourites..!!"); window.location.href="Advertisement_Stationary.php"; </script>';   }
	   else
	   {  echo '<script> alert("Error..!!"); window.location.href="Advertisement_Stationary.php"; </script>';   }   
	   }
	   else
	   {  echo '<script> alert("Already added !!"); window.location.href="Advertisement_Stationary.php"; </script>'; 
	   }
  } 
  ...
  {   
       ...
       $db='roomiee';
       $con= mysqli_connect("$dbhost","$username","$pass","$db") ;
	   $stationeryid=$stationery_id;
       
	   if(!isset($_COOKIE[$stationery_id])) {
       $sql="Update stationery set No_of_reports=No_of_reports+1 WHERE stationery_id='$stationeryid'";
       $a=mysqli_query($con,$sql);
       if($a)
       {  
	      setcookie($stationery_id,'1');
	      echo '<script> alert("Advertisement reported.!!"); window.location.href="Advertisement_Stationary.php"; </script>'; 
       }
       else
       { echo '<script> alert("Failed to report Ad!!"); window.location.href="Advertisement_Stationary.php"; </script>'; 
       } }
	   else
	   { echo '<script> alert("Ad. already reported !!"); window.location.href="Advertisement_Stationary.php"; </script>'; 
       }
  }	   
  ...
  {  if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['review']))
	 {  	  $dbhost='localhost';
              ...
              $sql="Insert into reviews_stationery values('','$name','$email','$review','$stationery_id','$User_id') ";
			  $result=mysqli_query($con,$sql);
			  if($result)
			  { echo '<script> alert("SUCCESS"); window.location.href="Advertisement_Stationary.php"; </script>';
		      }
			  else
			  { echo '<script> alert("ERROR"); window.location.href="Advertisement_Stationary.php"; </script>';
			  }
     ...
     {  echo '<script> alert("Fill all the fields..!!"); window.location.href="Advertisement_Stationary.php"; </script>';   }
  }	 
?> 
...
<head>
  ...
  <title>Advertisement Stationery</title>
		...
		<div class="row">
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
								...
								<?php
                                    ...
                                    $sql="Select * from reviews_stationery where stationery_id='$stationery_id'";
			                        $result=mysqli_query($con,$sql);
                                ...
                                ?>		
									<div class="media">
									 <?php 
									   $sql1="Select User_image from user where User_id IN(Select User_id from reviews_stationery where review_id='$review_id')";
									...
									<div class="review-submission">
										...
										<div class="review-submit">
											<form action="Advertisement_Stationary.php" method="post" class="row">
										        <br><br>
												<div class="col-lg-6">
			...
			<div class="col-md-4">
				<div class="sidebar">
					...
					<?php  
					  $q="Select * from user where User_id IN( Select User_id from stationery where stationery_id='$stationery_id')";
					...
					<div class="widget coupon text-center">
						...
						<!-- Submii button -->
						<form action="Advertisement_Stationary.php" method="Post">
