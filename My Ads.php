<?php session_start(); 
    ...
    {  $dbhost='localhost';
	   ...
	   if($result)
	   { echo '<script> alert("Ad deleted successfully..!"); window.location.href="My Ads.php"; </script>' ; }
       else
  ...
  if(isset($_POST['delete_mess']))
    {  $dbhost='localhost';
	   ...
	   $sql="DELETE FROM mess WHERE mess_id='$mess_id'";
	   $result=mysqli_query($con,$sql);
	   if($result)
	   { echo '<script> alert("Ad deleted successfully..!"); window.location.href="My Ads.php"; </script>' ; }
       else
  ...
  {  
	...
	if(isset($_POST['edit_mess']))
  {  
	   $mess_id=$_POST['mess_id'];
	   $_SESSION['mess_id']=$mess_id;
	   header('Location:Edit_Mess.php'); 
  }
  ...
  if(isset($_POST['delete_stationery']))
    {  $dbhost='localhost';
	   ...
	   $sql="DELETE FROM stationery WHERE stationery_id='$stationery_id'";
	   $result=mysqli_query($con,$sql);
	   if($result)
	   { echo '<script> alert("Ad deleted successfully..!"); window.location.href="My Ads.php"; </script>' ; }
       else
	...
	if(isset($_POST['edit_stationery']))
    {  
	   $stationery_id=$_POST['stationery_id'];
	   $_SESSION['stationery_id']=$stationery_id;
	   header('Location:Edit_Stationery.php'); 
	}  
    ...
    <div class="row">
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
		...
		<?php 
              ...
              $db='roomiee';
              $con= mysqli_connect("$dbhost","$username","$pass","$db") ; 
              $sql="Select * from stationery where User_id='$User_id'";
			  $result=mysqli_query($con,$sql);
			  $count=mysqli_num_rows($result);
			  for($i=0;$i<$count;$i++)
			  {   while($row=mysqli_fetch_assoc($result))
              ...
              <tr>
                ...
                <form method="post" action="My Ads.php">
                      ...
                      <div class="icon-input-btn">
		              <i class="fa fa-pencil"></i> 
                      <input type="submit" name="edit_stationery" value="">
                      </div>
                      <div class="icon-input-btn">
		              <i class="fa fa-trash"></i> 
        ...
        $db='roomiee';
        $con= mysqli_connect("$dbhost","$username","$pass","$db") ;
        $sql="Select * from mess where User_id='$User_id'";
			  $result=mysqli_query($con,$sql);
			  $count=mysqli_num_rows($result);
			  for($i=0;$i<$count;$i++)
			  {   while($row=mysqli_fetch_assoc($result))
              ...
              <tr>
                ...
                <form method="post" action="My Ads.php">
                      ...
                      <div class="icon-input-btn">
		              <i class="fa fa-pencil"></i> 
                      <input type="submit" name="edit_mess" value="">
                      </div>
                      <div class="icon-input-btn">
		              <i class="fa fa-trash"></i> 
