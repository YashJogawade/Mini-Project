<?php session_start();
  ...
  {    $dbhost='localhost';
	   ...
	   $q="select * from favourite where User_id='$User_id' AND room_id='$roomid'";
	   $res=mysqli_query($con,$q);
	   $n=mysqli_num_rows($res);
	   
	   if($n==0){
	   $sql="INSERT INTO favourite values('$User_id','$roomid')";
       $a=mysqli_query($con,$sql);
       if($a)
	   {  setcookie($roomid,'1');
	      echo '<script> alert("Added to your favourites..!!"); window.location.href="Advertisement_Room.php"; </script>';   }
	   else
	   {  echo '<script> alert("Error..!!"); window.location.href="Advertisement_Room.php"; </script>';   }   
	   }
	   else
	   {  echo '<script> alert("Already added !!"); window.location.href="Advertisement_Room.php"; </script>'; 
	   }
  } 
  ...
  {   
       ...
       $sql="Update room set No_of_reports=No_of_reports+1 WHERE room_id='$roomid'";
       $a=mysqli_query($con,$sql);
       if($a)
       {  
	      setcookie($room_id,'1');
	      echo '<script> alert("Advertisement reported.!!"); window.location.href="Advertisement_Room.php"; </script>'; 
       }
       else
       { echo '<script> alert("Failed to report Ad!!"); window.location.href="Advertisement_Room.php"; </script>'; 
       } }
	   else
	   { echo '<script> alert("Ad. already reported !!"); window.location.href="Advertisement_Room.php"; </script>'; 
       }
  }	   
  ...
  {  if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['review']))
	 {  	  $dbhost='localhost';
              ...
              $sql="Insert into reviews values('','$name','$email','$review','$room_id','$User_id') ";
			  $result=mysqli_query($con,$sql);
			  if($result)
			  { echo '<script> alert("SUCCESS"); window.location.href="Advertisement_Room.php"; </script>';
		      }
			  else
			  { echo '<script> alert("ERROR"); window.location.href="Advertisement_Room.php"; </script>';
			  }
     ...
     {  echo '<script> alert("Fill all the fields..!!"); window.location.href="Advertisement_Room.php"; </script>';   }
  }	 
?> 
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                ...
                                ?>		
									<div class="media">
									 <?php 
									   $sql1="Select User_image from user where User_id IN(Select User_id from reviews where review_id='$review_id')";
									...
									<div class="review-submission">
										...
										<div class="review-submit">
											<form action="Advertisement_Room.php" method="post" class="row">
										        <br><br>
												<div class="col-lg-6">
			...
			<div class="col-md-4">
				<div class="sidebar">
					<div class="widget price text-center">
						<h4>Rent( Monthly in Rs )</h4>
						<p><?php echo $row['price']; ?></p>
					</div>
					<!-- User Profile widget -->
					
					<?php  
					  $q="Select * from user where User_id IN( Select User_id from room where room_id='$room_id')";
					...
					<div class="widget coupon text-center">
						...
						<!-- Submii button -->
						<form action="Advertisement_Room.php" method="Post">
