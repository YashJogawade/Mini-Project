...
================================-->
    ...
    <section class="hero-area bg-1_2 text-center overly">
        <!-- Container Start -->
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="content-block">
                        <div class="short-popular-category-list text-center">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="#" class="select"><i class="fa fa-book"></i> Stationery Items</a>
                                </li>
                        </div>
											...
											<div class="form-row">
												...
												<div class="form-group col-md-3">
													<select class="w-100 form-control mt-lg-1 mt-md-2" id="search_category">
														...
														<option value="4">College supplies</option>
	...
	<ul class="category-list">
		<li><a href="">Books <span></span></a></li>
		<li><a href="">Office supplies<span></span></a></li>
		<li><a href="">College supplies<span></span></a></li>
    <li><a href="">Art & Craft<span></span></a></li>
		...
		<input type="button" id="price-filter-btn" align="center" class="btn btn-primary" value="Apply" style="height:30px; padding:2px 10px;">	
	               ...
	               <script type="text/javascript" src="Js/jquery-3.5.1.js"> </script> 
					...
					$(document).ready(function(){
                        ...
                        $.ajax({
                        url:"price-filter_stationery.php",
                        type:"POST",
...
=============================-->
    ...
    <section class="call-to-action overly bg-3_2 section-sm">
        <!-- Container Start -->
        <div class="container">
