<?php session_start();
  ...
  {  if(!empty($_POST['title']) && !empty($_POST['location']) && !empty($_POST['category']) &&  !empty($_POST['description']) && !empty($_FILES["image1"]["tmp_name"]) && !empty($_FILES["image2"]["tmp_name"]) &&  !empty($_FILES["image3"]["tmp_name"]) )
     { $dbhost='localhost';
       $username='root';
       $pass='';
       $db='roomiee';
	   ...
	   $sql="Insert into mess values('','$title','$category','$location','$description','$image1','$image2','$image3','$User_id',0)" ;
	   $a=mysqli_query($con,$sql) ;
	   if($a)
	    {   echo '<script> alert("Ad posted successfully..!"); window.location.href="Add Mess.php"; </script>' ;
	    }
		else
		{  echo '<script> alert("Failed to post ad..!"); window.location.href="Add Mess.php"; </script>' ; }
     }
	 else 
     { echo '<script> alert("Fill all the details."); window.location.href="Add Mess.php"; </script>' ;}
  }
?>
...
<body class="body-wrapper">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer border-top-0 mb-3 mx-5 justify-content-lg-between justify-content-center">
                                        ...
                                        <button type="button" class="btn btn-danger" href="index.html">Yes, Sure</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="ad-post bg-gray py-5">
        <div class="container">
            <form action="Add Mess.php" method="POST" enctype="multipart/form-data">
                <!-- Post Your ad start -->
                <fieldset class="border border-gary p-4 mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h6 class="font-weight-bold pt-4 pb-1">Select Mess Category:</h6>
               ...
               <!-- <div class="checkbox d-inline-flex">
                ...
                <button type="submit" name="postad" class="btn btn-primary d-block mt-2" href="Add Room.php">Post Your Ad</button>
            </form>
            </div>
    </section>
    <!--============================
            ...
            <div class="row">
                <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
                    ...
                    <div class="block about">
                        ...
                        <!-- description -->
                        <p class="alt-color">This is a student friendly website which will help students/tenants to explore Rooms/PG/Hostel around them including some other basic facilities like Mess , stationary materials. Point of this undertaking to build up a versatile
                            application for Hostel Students to diminish their issues.</p>
                    </div>
                </div>
                <!-- Link list -->
